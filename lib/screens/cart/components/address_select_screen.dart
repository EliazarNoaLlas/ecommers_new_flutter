import 'package:ecommers_new/providers/address_provider.dart';
import 'package:ecommers_new/providers/order_provider.dart';
import 'package:ecommers_new/screens/cart/components/address_form_screen.dart';
import 'package:ecommers_new/screens/cart/components/checkout_page.dart';
      ...
      actions: [
        IconButton(
          onPressed: () {
            ...
            // PersistentNavBarNavigator.pushNewScreen(context, screen: AddressFormScreen());
          },
          icon: Icon(
            Icons.add,
