...
import 'package:ecommers_new/screens/cart/components/address_select_screen.dart';
import 'package:ecommers_new/screens/cart/components/empty_cart_screen.dart';
                    ...
                    child: RoundedButton(
                      ...
                      onPressed: () {
                        if (Provider.of<UserProvider>(context, listen: false)
                            .isLoggedIn) {
                          PersistentNavBarNavigator.pushNewScreen(context, screen: AddressSelectScreen());
                        } else {
